...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 12:13:05 2019

@author: makhtardiop
"""

tocken='sk_97ee266172b348f6afb7db127c75880d'
...
def get_etf_holdings(etf_symbol):
    ...
    browser = WebDriver('/usr/local/bin/chromedriver')
    browser.get(url)
    ...
    for row in table.select('tr')[1:-1]:
        try:
            ...
            print(ex)
    browser.quit()
    data=pd.DataFrame(asset_dict)
    print (data.head())
    data.to_csv('spy_holdings.csv')
